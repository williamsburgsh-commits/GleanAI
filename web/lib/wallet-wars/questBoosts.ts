...
export const QUEST_BOOST_HINTS: { slug: string; label: string; boost: Partial<QuestBonus> }[] = [
  ...
  { slug: 'stake-sol', label: 'Stake SOL', boost: { shield: 25 } },
  { slug: 'stake-more', label: 'Stake More', boost: { shield: 15 } },
...
export function computeQuestBonus(completedSlugs: Set<string>): QuestBonus {
  const bonus: QuestBonus = { shield: 0, power: 0, strike: 0, agility: 0 };
